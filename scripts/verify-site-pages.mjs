...
const SITE_PAGES = [
  ...
  { label: 'Blog Page 2', path: '/blog/2' },
  { label: 'Blog Page 3', path: '/blog/3' },
  { label: 'Blog Page 4', path: '/blog/4' },
  { label: 'Blog Page 5', path: '/blog/5' },
  { label: 'Blog Page 6', path: '/blog/6' },
  { label: 'Blog Page 7', path: '/blog/7' },
  { label: 'Blog Page 8', path: '/blog/8' },
  { label: 'Blog Page 9', path: '/blog/9' },
